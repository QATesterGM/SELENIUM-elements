...
public class WebElementyWarsztat {
    ...
    public void zamawianieProduktu(){
        ...
        System.out.println("Nazwa produktu na stronie szczegolow produktu = " + nazwaProduktuNaStronieSzczegolowProduktu);
        System.out.println("Cena produktu na stronie szczegolow produktu = " + cenaProduktuNaStronieSzczegolowProduktu);
